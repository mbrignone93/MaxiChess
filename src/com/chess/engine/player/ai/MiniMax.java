...
public final class MiniMax implements MoveStrategy {
    ...
    public Move execute(final Board board) {
        ...
        int currentValue;
        System.out.println(board.currentPlayer() + " AI Pensando con Dificultad " + this.searchDepth);
        ...
        for (final Move move : board.currentPlayer().getLegalMoves()) {
            ...
            if (moveTransition.getMoveStatus().isDone()) {
                ...
                System.out.println("\t" + toString() + " Analizando Movimiento (" +moveCounter + "/" +numMoves+ ") " + move +
                                   " Puntos " + currentValue + " " +this.freqTable[this.freqTableIndex]);
                this.freqTableIndex++;
                ...
                System.out.println("\t" + toString() + " No Se Puede Ejecutar Movimiento (" +moveCounter+ "/" +numMoves+ ") " + move);
            }
            moveCounter++;
        }

        this.executionTime = System.currentTimeMillis() - startTime;
        System.out.printf("%s Selecciona %s [#Tableros = %d Tiempo Tomado = %d ms, Valocidad = %.1f\n", board.currentPlayer(),
        ...
        if(this.boardsEvaluated != total) {
            System.out.println("Hay Algo Incorrecto con el Numero de Tableros Evaluados!");
        }
        return bestMove;
    }
